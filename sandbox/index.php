...
$content = "<br /><br />";
$query = "SELECT * FROM `sandbox` ORDER BY pr DESC";
$result = mysql_query($query) or die(mysql_error());
$index = mysql_fetch_array($result, MYSQL_ASSOC);
while ($index) {
    if ($admin == 1) $content = $content . "<a href='/admin/sandbox_edit.php?id={$index['id']}'>Редактировать</a>
     <a href='/admin/sandbox_process.php?do=delete&id={$index['id']}'>Удалить</a>";
...
if ($admin == 1) $content = $content . "<h2><a href='/admin/sandbox_create.php' style='margin: 0;'>Создать</a></h2>";
$content = $content . "<br />";
