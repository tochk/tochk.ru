...
while ($lim <= 30) {
    ...
    $myData->AddPoint($row[$lim]["hosts"], "hosts");
    $myData->AddPoint($row[$lim]["hits"], "hits");
    $lim++;
}
$myData->SetAbsciseLabelSerie("day");
$myData->AddSerie("hosts");
$myData->SetSerieName(mb_convert_encoding("���������� �������������", 'utf-8', 'windows-1251'), "hosts");
$myData->AddSerie("hits");
$myData->SetSerieName(mb_convert_encoding("��������� �� ���������", 'utf-8', 'windows-1251'), "hits");
$graph = new pChart(1000, 500);
$graph->setFontProperties("Fonts/tahoma.ttf", 10);
$graph->setGraphArea(60, 60, 940, 440);
...
$graph->setFontProperties("Fonts/tahoma.ttf", 10);
$graph->drawTitle(480, 22, mb_convert_encoding("������������ tochk.ru", 'utf-8', 'windows-1251'), 50, 50, 50, -1, -1, true);
$graph->Stroke();
?>