...
while ($index) {
    ...
    $content .= "<div id='block_new_sait' onclick=\"window.location.href='{$index['url']}'\"> <div id='block_in_block_sait'><div id='block_in_block_sait_2'><div id='block_sait_head'>{$index['name']}</div><div id='block_sait_scrin_info'>
